...
Blockly.common.defineBlocksWithJsonArray([
  ...
  // ── MOTION ───────────────────────────────────────────────────────
  {
    ...
    previousStatement: null, nextStatement: null, colour: '#1260A1',
  },
  {
  ...
  // Motion reporters
  { type: 'sprite_x_position', message0: 'x position', output: 'Number', colour: '#1260A1' },
  { type: 'sprite_y_position', message0: 'y position', output: 'Number', colour: '#1260A1' },
  { type: 'sprite_direction',  message0: 'direction',  output: 'Number', colour: '#1260A1' },
  ...
  // ── LOOKS ────────────────────────────────────────────────────────
  {
    ...
    previousStatement: null, nextStatement: null, colour: '#4FA8D8',
  },
  {
    type: 'sprite_say',
    message0: 'say %1',
  ...
  { type: 'sprite_next_costume', message0: 'next costume', previousStatement: null, nextStatement: null, colour: '#4FA8D8' },
  {
  ...
  { type: 'sprite_show', message0: 'show', previousStatement: null, nextStatement: null, colour: '#4FA8D8' },
  { type: 'sprite_hide', message0: 'hide', previousStatement: null, nextStatement: null, colour: '#4FA8D8' },
  {
  ...
  // Looks reporters
  { type: 'sprite_size_reporter', message0: 'size', output: 'Number', colour: '#4FA8D8' },
  ...
  },
  {
    ...
    previousStatement: null, nextStatement: null, colour: '#F57E0F',
  },
  {
  ...
  // ── CONTROL ──────────────────────────────────────────────────────
  {
    ...
    previousStatement: null, nextStatement: null, colour: '#FBB454',
  },
  {
    type: 'sprite_repeat',
    message0: 'repeat %1',
  ...
  // Arithmetic (Number reporters)
  {
    ...
    output: 'Number', colour: '#8B6FD1', inputsInline: true,
  },
  {
  ...
  // Comparison (Boolean reporters)
  {
    ...
    output: 'Boolean', colour: '#8B6FD1', inputsInline: true,
  },
  {
    type: 'sprite_lt',
    message0: '%1 < %2',
  ...
  // String
  {
    ...
    output: 'String', colour: '#8B6FD1', inputsInline: true,
  },
  {
  ...
  { type: 'sprite_mouse_x', message0: 'mouse x', output: 'Number', colour: '#2EBF91' },
  { type: 'sprite_mouse_y', message0: 'mouse y', output: 'Number', colour: '#2EBF91' },
  { type: 'sprite_mouse_down', message0: 'mouse down?', output: 'Boolean', colour: '#2EBF91' },
  { type: 'sprite_timer', message0: 'timer', output: 'Number', colour: '#2EBF91' },
  {
    type: 'sprite_reset_timer',
    message0: 'reset timer',
    previousStatement: null, nextStatement: null, colour: '#2EBF91',
  },
]);
